    ...
    <div className='h-full'>
        <div className='container mx-auto mt-10 flex flex-col md:flex-row justify-around items-center'>
            <div className='rounded-lg py-3'>
                <Image className='w-[300px] p-5' src={NEXTT} alt="Book"/>
                <p className='text-center text-2xl font-bold'>NEXT JS</p>
                <p className='text-center text-cyan-800 text-xl py-3 font-bold'>#25,000</p>
