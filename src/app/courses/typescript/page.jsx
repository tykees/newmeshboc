    ...
    <div className='h-full'>
        <div className='container mx-auto mt-10 flex flex-col md:flex-row justify-around items-center'>
            <div className='rounded-lg py-3'>
                <Image className='w-[300px] p-5' src={TS} alt="Book"/>
                <p className='text-center text-xl font-bold'>TYPESCRIPT</p>
        ...
        <p className='text-center text-2xl font-bold py-3 mt-10'>What To Learn</p>
      <div>
